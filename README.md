...
A professional-grade, **offline-first** Flutter app for tracking home poker cash games with **seamless cloud synchronization**. Manage buy-ins, settle debts with partial payments, analyze your poker career with graphs & achievements, and run tournaments — all on your phone.

> **[📥 Download APK (v3.0)](./PokerTracker.apk)** — Install directly on any Android device.

---

## ☁️ Version 3.0: Cloud Sync

- **Seamless Multi-Device Sync:** Sign in securely with your phone number. The app instantly pulls your entire game history, player profiles, and debt ledgers.
- **Cross-Device Identity:** Play on an Android phone, check stats on an iPad. Your phone number is your universal identity across the ecosystem.
- **Offline Reliability:** No internet in the basement? No problem. The app queues all your games and payments locally and automatically syncs them to the cloud the second you regain connection.
- **Bi-Directional Debt Sync:** Settle up with a friend over GPay, record it on your phone, and their phone will automatically download the payment record next time they open the app.
- **In-App Updater:** The profile menu now includes a "Check for Updates" button to pull the latest APK directly from GitHub.
